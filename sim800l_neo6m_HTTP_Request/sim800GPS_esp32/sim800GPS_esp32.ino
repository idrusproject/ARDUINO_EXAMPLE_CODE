...
TinyGPSPlus gps;
SoftwareSerial simSerial(27, 26);
AltSoftSerial gpsSerial(25, 33);
...
void gsmHttpPost(float latitude, float longitude, float altitude) {
  ...
  Serial.println("6/12");
  //  gsmATCommand("AT+HTTPPARA=CONTENT,application/x-www-form-urlencoded");
  gsmATCommand("AT+HTTPPARA=CONTENT,application/json");
  Serial.println("7/12");
